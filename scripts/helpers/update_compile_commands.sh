...
# Change to generate thermostat compile commands
gn --root="$CHIP_ROOT/examples/thermostat/cc13x2x7_26x2x7" gen "$CHIP_ROOT/out/cc13x2x7_26x2x7-LP_CC2652R7-thermostat" --export-compile-commands
# CLion does not like having the compile_commands reference the symlink, so replace it with a direct reference to the files
sed -i -e 's:../../examples/thermostat/cc13x2x7_26x2x7/third_party/connectedhomeip/:../../:g' "$CHIP_ROOT/out/cc13x2x7_26x2x7-LP_CC2652R7-thermostat/compile_commands.json"